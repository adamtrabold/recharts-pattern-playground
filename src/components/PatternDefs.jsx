...
import { generatePatternDef, renderPatternContent, getPatternId } from '../utils/patternGenerator';

/**
 * PatternDefs component - renders SVG pattern definitions
 * This should be placed inside a Recharts chart's customized SVG area
 */
